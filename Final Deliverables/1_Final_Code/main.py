...
client = Cloudant.iam("eb552b7-ae45-4df8-8d1c-69c5229ffdbe-blumix","YzG5FZg9s_HScOBZaWyVXm7PpNjPrmPaPMfHxw3X9",connect=True)
my_database = client.create_database("database-sundar")
